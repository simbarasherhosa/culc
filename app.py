...
#         r"/ai/*": {
#             "origins": ["http://localhost:3000", "http://127.0.0.1:3000", "https://www.taxcul.com/"],
#             "methods": ["GET", "POST", "OPTIONS"],
#             "allow_headers": ["Content-Type", "Authorization", "X-Elite-Client"],
...
#     else:
#         # Production server (using waitress for Windows, gunicorn for Linux)
#         try:
